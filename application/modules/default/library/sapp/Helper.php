                ...
                if($tot_rec_cnt > 0)
                {
                    for($i=2; $i <= $sizeOfWorksheet; $i++ )
                    {
                        ...
                        $text = "<div style='padding: 0; text-align: left; font-size:14px; font-family:Arial, Helvetica, sans-serif;'>				
                                        ...
                                        <div style='padding:20px 0 0 0;color:#3b3b3b;'>Welcome to TeamHalt HRMS! We're excited to have you on board. Your login details are:</div>
                                        ...
                                        <div style='padding:20px 0 10px 0;'>Please <a href='".BASE_URL."index/popup' target='_blank' style='color:#b3512f;'>click here</a> to access your HRMS account. Explore the user-friendly interface designed to streamline your.
                                        <br>experience. Need assistance? Our support team is here for you.</div>
                    

                                </div>";
                        $options['subject'] = ' Welcome to TeamHalt HRMS!';
                        // $options['header'] = 'Welcome to TeamHalt HRMS!';
