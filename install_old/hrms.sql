...
CREATE TABLE `tm_projects` (
  ...
  `description` varchar(500) DEFAULT NULL,
  `esic_no` bigint(20) unsigned NOT NULL,
  ...
  `modified` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `FK_tm_projects_client` (`esic_no`),
  KEY `FK_tm_projects_currency` (`currency_id`),
  CONSTRAINT `FK_tm_projects_client` FOREIGN KEY (`esic_no`) REFERENCES `tm_clients` (`id`),
